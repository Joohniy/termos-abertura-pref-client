...
export const generateCotaSemLetra = (nfolha, nprocesso, anoprocesso, date, nome, secretaria, cargo, assinantes, volaberto, flpedido) => {
    const doc = new jsPDF();
    ...
    doc.setFontSize(13);
    doc.setFont("Arial");
    const stringPapelInformacaoCota = `Papel para informação, rubricado como folha nº ${Number(nfolha) + 2}`;
